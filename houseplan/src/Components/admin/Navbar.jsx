...
const Navbar = () => {
    ...
    const navData = [
        { label: 'Dashboard', link: '/admin/', icon: 'bx-layer' },
        { label: 'Collection', link: '/admin/collection', icon: 'bx-collection' },
        { label: 'Specs & Features', link: '/admin/specs', icon: 'bx-list-plus' },
        { label: 'Post', link: '/admin/post', icon: 'bxs-cloud-upload' },
        { label: 'Price', link: '/admin/price', icon: 'bxs-cloud-upload' },
    ]
            ...
            <>
                <section id="body-pd" className={show ? 'body-pd' : null}>
                    ...
                    <div className={`l-navbar show_des ${show ? 'show' : null}`} id="nav-bar">
                        <nav className="nav">
                            <div>
                                <Link to="/admin/" className="nav__link" style={{ textDecoration: 'none' }} >
